...
public class EstateAgent {
    ...
    public EstateAgent setId(int id) {
        this.id = id;
        return this;
    }
    ...
    public EstateAgent setName(String name) {
        this.name = name;
        return this;
    }
    ...
    public EstateAgent setAddress(String address) {
    ...
    public EstateAgent setLogin(String login) {
        this.login = login;
        return this;
    }
    ...
    public EstateAgent setPassword(String password) {
