...
/* The following type implements a suffix tree based on data structures
   ...
   unsigned long. To output a value of type GtUword use the format
   GT_WU instead of %lu. */
...
/* The following function the location <loc> to stdout. */
...
/* This is the constructor for the suffix tree stored in an index
...
/* This is the destructor for the object of type
   <GtStreeLocIter>. */
...
/* The following function applies the function given as second argument
   ...
   location iterator. The third argument is used as the first argument
   of the <process_loc>. If an error occurs, the function returns
